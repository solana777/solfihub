    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          backgroundImage: `linear-gradient(180deg, ${theme.vars.palette.background.default} 12%, ${varAlpha(theme.vars.palette.background.defaultChannel, 0.75)} 50%, ${theme.vars.palette.background.default} 88%), url('${CONFIG.site.basePath}/assets/images/home/solana-landing-img.png')`,
          [stylesMode.dark]: {
            backgroundImage: `url('${CONFIG.site.basePath}/assets/images/home/hero-blur.webp'), linear-gradient(180deg, ${theme.vars.palette.background.default} 12%, ${varAlpha(theme.vars.palette.background.defaultChannel, 0.75)} 50%, ${theme.vars.palette.background.default} 88%), url('${CONFIG.site.basePath}/assets/images/home/solana-landing-img.png')`,
          },
        }}
      />
    </Stack>
